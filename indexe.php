...
<div id="wapper" >  <!------ wrapper permet d'etirer l'header---------->
 ...
 <div class="carousel-inner">
    ...
    <h5>Maison moins chère à votre portée</h5>
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="img/v5.jpg" alt="Second slide"  height="370px">
       <div class="carousel-caption d-none d-md-block">
    <h5>Des appartement à vous couper le soufle</h5>
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="img/v2.jpg" alt="Third slide"  height="370px">
       <div class="carousel-caption d-none d-md-block">
    <h5>Ne cherchez pas loin tout est là</h5>
    ...
    <p>Une ville d'avenir</p>
     ...
     <div class="carousel-item">
      <img class="d-block w-100" src="img/t1.png" alt="Second slide"  height="370px">
       <div class="carousel-caption d-none d-md-block">
    <h5>Trés simple</h5>
    <p>Vous n'avez pas besoin de vous déplacer</p>
  </div>
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/e3.png" alt="Third slide"  height="370px">
       <div class="carousel-caption d-none d-md-block">
    <h5>Venez vite</h5>
    <p>vous n'êtes pas les seuls à les convoiter</p>
  </div>
    </div>
     <div class="carousel-item">
    ...
    <p>Toutes vos questions trouvent leur réponse ici</p>
  </div>
    </div>
    <div class="carousel-item">
    ...
    <p>A vous de voir</p>
     ...
     <div class="carousel-item">
      <img class="d-block w-100" src="img/v4.jpg" alt="Second slide"  height="370px">
       <div class="carousel-caption d-none d-md-block">
    <h5>Des mangazins bien placés</h5>
    <p>Dans tous les marchés du monde</p>
  </div>
    </div>
...
<div class="card" style="width:400px">
  ...
  <div class="card-img-overlay">
    <h3 style='color : white'>Trouver des marchands ambulants qui se déplaceront pour vous vendre</h3>
