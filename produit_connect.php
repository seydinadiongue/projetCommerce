...
<div id="wapper" >  <!------ wrapper permet d'etirer l'header---------->
	...
	$req = 'Select * from produit p JOIN image i on p.idprod=i.idprod group by p.idprod';
	$urls = $bdd->query($req);
	...
	$cant = $_GET['cant'];
	$lieu = $_GET['lieu'];
	echo '<h2 class="text-center">Bienvenue chez '.$cant.'</h2><hr/>';
	...
	<div id="result"></div>
	<?php
	echo '<div class="tout" style="margin :0 0 2% 8%">';
...
<script>
		...
		// $(document).ready(function(){
			...
			// $('#search').keyup(function(){
				...
				// if(txt!= ""){
					// $.ajax({
						// url:"fetch_connect_produit.php?idcom=$_GET['idcom']&col=$_GET['col']",
						// method:"post",
						// data:{search:txt},
						// dataType:"text",
