    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <div class="nav-item " style="margin-left : 70%;">
  ...
  <div style='background : white; margin : 0 13% 0 13%; padding-bottom : 35%;'>
   ...
   <?php
	...
	?>
		...
		<div style='margin-left : 25%;margin-top : 5%;margin-bottom : 15%;width : 600px;height : 300px;background : url("<?php echo $row['photo'] ?>"); background-repeat : no-repeat;background-size : 100% 100%;border-radius : 2%  '>
	<?php
        echo '<img style="margin-left : 34%;margin-top : 32%;width : 200px;height: 200px;  border-radius : 50%; border : 5px solid white" src="'.$_SESSION['pp'].'"/>';
