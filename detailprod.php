...
<?php
	if(isset($_GET['nomprod'])){
		echo '<h2 class="text-center" style="margin-top : 6%; ">Vous etes chez <span style="color :  #6ab04c">'.$_GET['cant'].'</span></h2><hr/>';
		echo '<h4 class="text-center" style="margin-top : %; letter-spacing : 4px">Voir plus d\'informations sur '.$_GET['nomprod'].'</h4><hr/>';
	}
?>
