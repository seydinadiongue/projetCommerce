...
<div id="wapper" >  <!------ wrapper permet d'etirer l'header---------->
	...
	<div class="container-fluid register" style="padding-top : 5%;border-top : 5px solid black;">
		<div class="col-md-3 register-left" style="margin-right : -7%; ">
			<div id="lui">
			<a href="luimeme_client.php"><img src = "<?= $_SESSION['pp']?>" alt="Profil" /></a></br>
			...
			<input class="btn btn-primary" style="font-weight : bold; color:white" type="submit" name="accueil" value="Notification(5)"/><br/>
		...
		<div class="col-md-9" style="height : 700px;background : white; border-radius : 10% 0% 0 15%;margin-right : -10px ; overflow-y : scroll">
		...
		<div id="result"></div>
		<?php
		echo "<div class='tout' style='margin-left : 10%; '>";
		...
		while($url = $urls->fetch()){
			echo '
				<div class="col-md-6" style="margin-bottom : 35px;">
					<div class="card shadow" style="width: 308px; border-radius : 10%;background : #F5F5F5  ; border : 0px solid black">
						...
						<div class="card-body text-center" style="height : 5rem;" box-shadow : 0px 2px 3px black>
							<a href="cantines_connect.php?idcom='.$url['idcom'].'" class="btn btn-danger btn-xs" style="margin-right : 3%">S\'abonner</a>
							<a href="collections_connect.php?idcom='.$url['idcom'].'" class="btn btn-default btn-xs" style="margin-left : 3%">voir les collections</a>
						</div>
					</div>
				</div>
			';
