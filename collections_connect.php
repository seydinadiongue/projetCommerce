...
<meta charset="utf-8"/>
	...
	<link rel="stylesheet" href="flottant_cnnect.css"/>
...
<nav class="navbar navbar-expand-lg navbar-inverse navbar-fixed-top" style="height : 1px ">
	...
	$ur = $stmt->fetch();
	$t=0;
	echo '<div class="text-center" style="font-family : italic; height : 85px; border-bottom :1px solid black; margin-bottom : 5%"><span class="t text1">Bienvenue chez </span><span class="t text2">'.$ur['nomcant'].'</span></div>';
	...
	echo '
		<div class="col-md-4" style="margin-bottom : 35px; ">
			<div class="card shadow" style="width: 208px; height : 200px;border-radius : 5%;background : url('.$url['url'].'); background-size : 100% 100%; border : 0px solid black">
				...
				<div class="card-body text-center" style="height : 6rem;" box-shadow : 0px 2px 3px black>
					<a href="produit_connect.php?idcom='.$url['idcom'].'&col='.$url['nomcol'].'&cant='.$ur['nomcant'].'&lieu='.$ur['lieu'].'" class="btn btn-primary btn-lg" style="margin-left : 3%; margin-top : 30%">voir les '.$url['nomcol'].'s</a>
				</div>
			</div>
		</div>
	';
