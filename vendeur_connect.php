	...
	<div class="container-fluid register" style="padding-top : 5%;border-top : 5px solid black;">
		...
		<div id="modal-wrapper" class="modal row" style=";margin : 4.3% 0% 0% 0%; width : 100%; height : 90%; background :  ; border : px solid black;">
			...
			<?php
				echo '<div class="text-center fixed" style="">
					<a href="cantines_connect.php"><input class="btn btn-info" style="font-weight : bold;float : left;margin : 2% 0 0 5% " type="submit" name="espaceClient" value="Cantines" /> </a>
					...
					<a href="vendeur_connect.php" ><input class="btn btn-info" style="font-weight : bold; float : right;margin : 2% 5% 0  "  type="submit" name="supprimer" value="Vendeur de table"/></a>
				</div><hr/>';
			?>
				<?php
				$bdd = new PDO('mysql:host=localhost; dbname=base', 'root', '');
				...
				while($row = $stmt->fetch()){
					...
					echo '<a href="vendeur_connect.php?id='.$row['envoyeur'].'" style="color : white"><div class="row">';
		...
		?>
			...
			?>
				...
				<div id="result"></div>
				<!--#########################Affichage des produits des vendeurs############################################-->
				<?php
						...
						echo '
							<div class="col-md-4" style="margin-bottom : 4%;">
									...
									<div class="text-center" style="height : 3rem; margin-top : -5% " >
										...
										<a href = "detailprodmar_connect.php?idprod='.$url['idprod'].'&nomprod='.$url['nomprod'].'&idvend='.$url['idvend'].'" class="btn btn-default btn-xs">Details</a>
									</div>
								</div>
							</div>
						';
