...
<h2 class="text-center">Bienvenue dans la foule des vendeurs</h2><hr/>
<?php
	...
	echo '
		<div class="col-md-3" style="margin-bottom : 4%;">
				...
				<div class="text-center" style="height : 3rem; margin-top : -5% " >
					...
					<a href="vendeur.php?idprod='.$url['idprod'].'"><input type="submit" value = "Reserver" class="btn btn-primary btn-xs" onclick="document.getElementById(\'modal-wrapper\').style.display=\'block\'"/></a>
...
<form class="col-lg-6 animate" method="post" action="vendeur.php?idprod='.$_GET["idprod"].'" style="background-color : rgba(169, 169, 169, 0.7);box-shadow : 5px black; border-radius : %;padding-bottom : 3% ">
