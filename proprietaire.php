  ...
  <div style='background : white; margin : 0 13% 0 13%; padding-bottom : 35%;'>
   ...
   <?php
	...
	?>
		...
		<div style='margin-left : 25%;margin-top : 4%;margin-bottom : 15%;width : 600px;height : 300px;background : url("<?php echo $row['photo'] ?>"); background-repeat : no-repeat;background-size : 100% 100%;border-radius : 2%  '>
	<?php
