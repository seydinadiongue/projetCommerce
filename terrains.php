...
<head>
  ...
  <title>Marçants ambulants</title>
...
?>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#">Gestion Immo==>Nos terrains</a>
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
           <div class="carousel-item active">
              <img class="d-block img" src="img/tt2.jpg" alt="First slide" width="900px" height="400px">
            </div>
            <div class="carousel-item">
              <img class="d-block img" src="img/ter1.jpg" alt="Second slide" width="900px" height="400px">
            </div>
            <div class="carousel-item">
              <img class="d-block img" src="img/tt1.jpg" alt="Third slide" width="900px" height="400px">
            </div>
              <div class="carousel-item">
              <img class="d-block img" src="img/ter4.png" alt="fourth slide" width="900px" height="400px">
            </div>
            <div class="carousel-item">
              <img class="d-block img" src="img/ter.jpg" alt="fifth slide" width="900px" height="400px">
            </div>
          </div>
...
$sql="select url from image where code=199";
     $resultat=$bdd->query($sql);
while ($donnee=$resultat ->fetch())
		{                    
						$urll=$donnee['url'];   
...
$sql="select url from image where code=200";
     $resultat=$bdd->query($sql);
while ($donnee=$resultat ->fetch())
		{                    
						$urll1=$donnee['url'];   
...
$sql="select url from image where code=201";
     $resultat=$bdd->query($sql);
while ($donnee=$resultat ->fetch())
		{                    
						$urll2=$donnee['url'];   
...
$sql="select url from image where code=202";
     $resultat=$bdd->query($sql);
while ($donnee=$resultat ->fetch())
		{                    
						$urll3=$donnee['url'];    
...
$sql="select url from image where code=203";
     $resultat=$bdd->query($sql);
while ($donnee=$resultat ->fetch())
		{                    
						$urll4=$donnee['url'];   
...
$sql="select url from image where code=204";
     $resultat=$bdd->query($sql);
while ($donnee=$resultat ->fetch())
		{                    
						$urll5=$donnee['url']; 						
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              ...
              <div class="card-footer">
                <small class="text-muted">&#9733; &#9733; <a href="authClientTER.php"> s'abonner</a> &#9733;<a href="authClient.php"> voir plus</a></small>
              </div>
            </div>
          </div>
