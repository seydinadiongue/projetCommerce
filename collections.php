...
<meta charset="utf-8"/>
	...
	<link rel="stylesheet" href="flottant.css"/>
    <!-- Bootstrap CSS -->
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <div class="nav-item " style="margin-left : 76%;border-left : 1px solid white">
            <div class="btn nav-link navbar-brand" style="color : white ; background : ">Rejoignez-nous au 338362689/777327178</div>
          </div>
        </ul>
...
if(isset($_GET['idcom'])){
	...
	$ur = $stmt->fetch();
	$t=0;
	echo '<div class="text-center" style="font-family : italic; height : 85px; border-bottom :1px solid black; margin-bottom : 5%"><span class="text1">Bienvenue chez </span><span class="text2">'.$ur['nomcant'].'</span></div>';
	while($url = $urls->fetch()){
	$t=1;
	echo '
		<div class="col-md-4" style="margin-bottom : 5px; ">
			<div class="card shadow" style="width: 208px; height : 200px;border-radius : 5%;background : url('.$url['url'].'); background-size : 100% 100%; border : 0px solid black">
				<div class="inner">
				</div>
				<div class="card-body text-center" style="height : 7rem;" box-shadow : 0px 2px 3px black>
					<a href="produit.php?idcom='.$url['idcom'].'&col='.$url['nomcol'].'&cant='.$ur['nomcant'].'&lieu='.$ur['lieu'].'" class="btn btn-primary btn-lg" style="margin-left : 3%; margin-top : 30%">voir les '.$url['nomcol'].'s</a>
				</div>
			</div>
		</div>
	';
	...
	if($t==0){
		echo '<h3 class="text-center" style="margin : 10% 0 10% 0">Aucun produit n\'est encore disponible</h3>';
	}
}
?>
</div>
